...
export class ArticleService {
  ...
  updateArticle(formdata : FormData, id : number) {
    ...
    return this.http.put<apiResponse<any>>(`${this.apiUrl}api/v1/article/${id}`,formdata, {headers : headers})
  }


  delete(id : number) : Observable<apiResponse<any>> {
    return this.http.delete<apiResponse<any>>(`${this.apiUrl}api/v1/artilce/${id}`);
  }
}
